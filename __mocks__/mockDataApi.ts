...
const mockDataApi: DataApi = {
  ...
  articles: [
    ...
    },
    {
      ...
      content:
        "(CNN) The artist behind the world's first underwater sculpture park has just unveiled his latest sub-aquatic project -- a spectacular sunken forest located off the coast of Pernera beach in Ayia Napa… ",
      description:

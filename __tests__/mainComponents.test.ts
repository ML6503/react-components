...
describe('select events', () => {
    it('select sort by published time change', () => {
        ...
        let options = appEl.getAllByTestId('select-option');
        ...
        expect((appEl.getByText('newest') as HTMLOptionElement).selected).toBeTruthy();
        expect((appEl.getByText('relevancy') as HTMLOptionElement).selected).toBeFalsy();
    ...
    it('select language change', () => {
        ...
        expect((appEl.getByText('Russian') as HTMLOptionElement).selected).toBeTruthy();

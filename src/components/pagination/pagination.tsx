...
const Pagination: React.FC<PaginationsProps> = ({ currentPage, setCurrentPage, linksArr, pageLinksNumber, inputValue, setInputValue}): JSX. Element => {
  const MAX_ALLOWED_FREE_PAGES = Math.floor(MAX_ALLOWED_FREE_ARTICLES/ inputValue);
    const ACTIVE_LINK_CLASS = 'active';
    console.log('current page', currentPage);
    console.log('page size', inputValue);
